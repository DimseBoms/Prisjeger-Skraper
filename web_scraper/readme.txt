...
Skriptet er for øyeblikket tilpasset til å kjøre på en raspberry pi med open source versjonen av Chrome, altså Chromium(https://www.chromium.org/) med ChromeDriver(https://chromedriver.chromium.org/) som webdriver men dette kan tilpasses i drivervariablene dersom skriptet skal kjøres på et annet system.
